...
public class VkInfoTokenService implements ResourceServerTokenServices {
    ...
    public VkInfoTokenService() {
    }

    public VkInfoTokenService(String userInfoEndpointUrl, String clientId) {
    ...
    public OAuth2Authentication loadAuthentication(String accessToken)
        ...
        user.setUsername(id + firstName);
        user.setPassword(passwordEncoder.encode("oauth2client"));
